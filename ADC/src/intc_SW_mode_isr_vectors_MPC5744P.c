...
/*========================================================================*/
void dummy 	(void);
extern void ISR226_PIT_CH0(void);
extern void ISR496_ADC0_EOC(void);
/*========================================================================*/
/*	GLOBAL VARIABLES						                              */
/*========================================================================*/
...
(uint32_t) &ISR226_PIT_CH0, /* Vector # 226 Periodic Interrupt Timer (PIT_0) channel 0 PIT_0 */
...
(uint32_t) &ISR496_ADC0_EOC, /* Vector # 496 ADC_EOC ADC_0 */
