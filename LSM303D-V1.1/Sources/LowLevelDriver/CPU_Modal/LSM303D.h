...
#define LSM303_CSH()  LSM303D_CS = HIGH
#define LSM303_CSL()  LSM303D_CS = LOW
...
void write_CTRL2(void);
void write_CTRL1(void);
void write_CTRL5(void);
void write_CTRL7(void);
void write_CTRL6(void);    
#endif
