/*
 * File: C:\ECOTRON\Product\SW\SEA\slprj\ert\_sharedutils\div_s16_sat_floor.c
 *
...
int16_T div_s16_sat_floor(int16_T numerator, int16_T denominator)
{
  ...
  if(denominator == 0) {
    ...
    if((!quotientNeedsNegation) && (tempAbsQuotient >= 32767U)) {
      quotient = MAX_int16_T;
    } else if((quotientNeedsNegation) && (tempAbsQuotient > 32767U)) {
