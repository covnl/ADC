/*
 * File: C:\ECOTRON\Product\SW\SEA\slprj\ert\_sharedutils\intrp2d_u8u8u16n15_lca_f.c
 *
 ...
 maxIndex)
{
  ...
  if((uint32_T)bpIndex[0UL] == maxIndex[0UL]) {
    ...
    if(yR_0d0 >= yR_1d) {
      yL_1d = (uint8_T)((uint16_T)yR_1d +
        (uint16_T)(uint8_T)(((uint32_T)frac[0UL] *
  ...
  if((uint32_T)bpIndex[1UL] == maxIndex[1UL]) {
    ...
    if(yR_1d >= yL_1d) {
      y = (uint8_T)((uint16_T)yL_1d + (uint16_T)(uint8_T)(((uint32_T)frac[1UL] *
