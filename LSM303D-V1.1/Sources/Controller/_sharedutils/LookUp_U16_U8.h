/*
 * File: C:\ECOTRON\Product\SW\SEA\slprj\ert\_sharedutils\LookUp_U16_U8.h
 *
...
#ifndef SHARE_LookUp_U16_U8
#define SHARE_LookUp_U16_U8

extern void LookUp_U16_U8( uint16_T *pY, const uint16_T *pYData, uint8_T u,
 const uint8_T *pUData, uint_T iHi);
