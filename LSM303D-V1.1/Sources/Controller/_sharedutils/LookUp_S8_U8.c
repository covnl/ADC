/*
 * File: C:\ECOTRON\Product\SW\SEA\slprj\ert\_sharedutils\LookUp_S8_U8.c
 *
...
/*********************************************************************
 * Fixed-Point Lookup Utility LookUp_S8_U8
 */
 ...
 *pUData, uint_T iHi)
{
  ...
  INTERPOLATE_S8_U8( pY, pYData[iLeft], pYData[iRght], u, pUData[iLeft],
   pUData[iRght]);
}

/* end function LookUp_S8_U8
 *********************************************************************/
