/*
 * File: C:\ECOTRON\Product\SW\SEA\slprj\ert\_sharedutils\INTERPOLATE_S8_U8.h
 *
...
#ifndef SHARE_INTERPOLATE_S8_U8
#define SHARE_INTERPOLATE_S8_U8

extern void INTERPOLATE_S8_U8( int8_T *pY, int8_T yL, int8_T yR, uint8_T x,
