/*
 * File: C:\ECOTRON\Product\SW\SEA\slprj\ert\_sharedutils\LookUp_U8_U16.c
 *
...
/*********************************************************************
 * Fixed-Point Lookup Utility LookUp_U8_U16
 */
 ...
 uint16_T *pUData, uint_T iHi)
{
  ...
  INTERPOLATE_U8_U16( pY, pYData[iLeft], pYData[iRght], u, pUData[iLeft],
   pUData[iRght]);
}

/* end function LookUp_U8_U16
 *********************************************************************/
