/*
 * File: C:\ECOTRON\Product\SW\SEA\slprj\ert\_sharedutils\intrp2d_u16u8u16n15_lca_f.c
 *
 ...
 *const maxIndex)
{
  ...
  if((uint32_T)bpIndex[0UL] == maxIndex[0UL]) {
    ...
    if(yR_0d0 >= yR_1d) {
      yL_1d = yR_1d + (uint16_T)(((uint32_T)frac[0UL] * (uint32_T)(yR_0d0 -
        yR_1d)) >> 15);
    } else {
      yL_1d = yR_1d - (uint16_T)(((uint32_T)frac[0UL] * (uint32_T)(yR_1d -
        yR_0d0)) >> 15);
    }
  }
  if((uint32_T)bpIndex[1UL] == maxIndex[1UL]) {
    ...
    if((uint32_T)bpIndex[0UL] == maxIndex[0UL]) {
      ...
      yR_1d = table[offset_0d];
      if(yR_0d0 >= yR_1d) {
        yR_1d = yR_1d + (uint16_T)(((uint32_T)frac[0UL] * (uint32_T)(yR_0d0 -
          yR_1d)) >> 15);
      } else {
        yR_1d = yR_1d - (uint16_T)(((uint32_T)frac[0UL] * (uint32_T)(yR_1d -
          yR_0d0)) >> 15);
      }
    }
    if(yR_1d >= yL_1d) {
      y = yL_1d + (uint16_T)(((uint32_T)frac[1UL] * (uint32_T)(yR_1d - yL_1d))
        >> 15);
    } else {
      y = yL_1d - (uint16_T)(((uint32_T)frac[1UL] * (uint32_T)(yL_1d - yR_1d))
        >> 15);
    }
  }
  return y;
