/*
 * File: C:\ECOTRON\Product\SW\SEA\slprj\ert\_sharedutils\div_s8s16_floor.h
 *
...
#ifndef SHARE_div_s8s16_floor
#define SHARE_div_s8s16_floor

extern int8_T div_s8s16_floor(int16_T numerator, int16_T denominator);
