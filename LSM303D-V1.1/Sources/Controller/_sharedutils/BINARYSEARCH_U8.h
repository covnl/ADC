/*
 * File: C:\ECOTRON\Product\SW\SEA\slprj\ert\_sharedutils\BINARYSEARCH_U8.h
 *
...
extern void BINARYSEARCH_U8( uint_T *piLeft, uint_T *piRght, uint8_T u, const
 uint8_T *pData, uint_T iHi);
