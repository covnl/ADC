/*
 * File: C:\ECOTRON\Product\SW\SEA\slprj\ert\_sharedutils\LookUp_U16_U8.c
 *
...
/*********************************************************************
 * Fixed-Point Lookup Utility LookUp_U16_U8
 */
 ...
 uint8_T *pUData, uint_T iHi)
{
  ...
  INTERPOLATE_U16_U8( pY, pYData[iLeft], pYData[iRght], u, pUData[iLeft],
   pUData[iRght]);
}

/* end function LookUp_U16_U8
 *********************************************************************/
