/*
 * File: C:\ECOTRON\Product\SW\SEA\slprj\ert\_sharedutils\Look2D_U8_U8_U8.c
 *
...
/*********************************************************************
 * Fixed-Point 2D Lookup Utility Look2D_U8_U8_U8
 */
 ...
 iHiU1)
{
...

  {
     ...
     */
    INTERPOLATE_U8_U8( pY, yLeftLeft, yLeftRght, u1, u1Left, u1Rght);

    /* Interpolate along U1 variable
     *    with the u0 variable locked on the right u0
     */
    INTERPOLATE_U8_U8( (&(yTemp)), yRghtLeft, yRghtRght, u1, u1Left, u1Rght);

    /*
     * Interpolate along u0 variable
     *    with the u1 variable locked on its interpolated value
     */
    INTERPOLATE_U8_U8( pY, (*pY), yTemp, u0, u0Left, u0Rght);
  }
}

/* end function Look2D_U8_U8_U8
 *********************************************************************/
