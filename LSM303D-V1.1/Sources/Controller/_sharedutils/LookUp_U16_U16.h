/*
 * File: C:\ECOTRON\Product\SW\SEA\slprj\ert\_sharedutils\LookUp_U16_U16.h
 *
...
extern void LookUp_U16_U16( uint16_T *pY, const uint16_T *pYData, uint16_T u,
 const uint16_T *pUData, uint_T iHi);
